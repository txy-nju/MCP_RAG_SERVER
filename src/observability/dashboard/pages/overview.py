...
from observability.dashboard.services.config_service import ComponentCard, ConfigService
...
def _render_data_stats(settings: object) -> None:
    ...
    try:
        from libs.vector_store.chroma_store import ChromaStore  # type: ignore[import]
